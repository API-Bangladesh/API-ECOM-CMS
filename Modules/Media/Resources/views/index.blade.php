        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="dt-entry__header">
                    ...
                    <!-- /entry heading -->
                    @if (permission('media-add'))
                        <button class="btn btn-primary btn-sm" onclick="showFormModal('Add New Media','Save');clearOldImage()">
                        ...
                        <form id="form-filter">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter Media">
                                </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{route('media.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url = "{{route('media.store.or.update')}}";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#store_or_update_modal .modal-title').html(
                                '<i class="fas fa-edit"></i> <span>Edit Media </span>');
            ...
            function multi_delete(){
                ...
                if(ids.length == 0){
                    ...
                    let url = "{{route('media.bulk.delete')}}";
            ...
            $(document).on('click', '.change_status', function () {
                ...
                let name  = $(this).data('name');
                let row   = table.row($(this).parent('tr'));
                let url   = "{{ route('media.change.status') }}";
